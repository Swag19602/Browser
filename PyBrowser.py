...
class Window(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('TorrBrowser')
        self.setWindowIcon(QIcon('icons/TorrBrowser.ico'))
        ...
        self.backButton.setIcon(QIcon('icons/backButton.png'))
        ...
        self.reloadButton.setIcon(QIcon('icons/Roload.png'))
        ...
        self.forwardButton.setIcon(QIcon('icons/forwardButton.jpg'))
